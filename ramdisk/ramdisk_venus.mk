PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/fstab.hi6250:root/fstab.hi6250 \
	$(LOCAL_PATH)/fstab.zram256m:root/fstab.zram256m \
	$(LOCAL_PATH)/fstab.zram512m:root/fstab.zram512m \
	$(LOCAL_PATH)/init.hi6250.rc:root/init.hi6250.rc \
	$(LOCAL_PATH)/ueventd.hi6250.rc:root/ueventd.hi6250.rc \
	$(LOCAL_PATH)/init:root/init\
	$(LOCAL_PATH)/init.4871.rc:root/init.4871.rc\
	$(LOCAL_PATH)/init.6193.rc:root/init.6193.rc\
	$(LOCAL_PATH)/init.51312.rc:root/init.51312.rc\
	$(LOCAL_PATH)/init.audio.rc:root/init.audio.rc\
	$(LOCAL_PATH)/init.balong_modem.rc:root/init.balong_modem.rc\
	...
	$(LOCAL_PATH)/init.connectivity.bcm43455.rc:root/init.connectivity.bcm43455.rc\
	$(LOCAL_PATH)/init.connectivity.gps.rc:root/init.connectivity.gps.rc\
	$(LOCAL_PATH)/init.connectivity.hisi.rc:root/init.connectivity.hisi.rc\
	...
	$(LOCAL_PATH)/init.recovery.balong_modem.rc:root/init.recovery.balong_modem.rc\
	$(LOCAL_PATH)/init.recovery.hisi.rc:root/init.recovery.hisi.rc\
	...
	$(LOCAL_PATH)/ueventd.4871.rc:root/ueventd.4871.rc\
	$(LOCAL_PATH)/ueventd.6193.rc:root/ueventd.6193.rc\
	$(LOCAL_PATH)/ueventd.51312.rc:root/ueventd.51312.rc\
	$(LOCAL_PATH)/ueventd.hi6250.rc:root/ueventd.hi6250.rc\
	...
	$(LOCAL_PATH)/sbin/hw_crit_service_sys:root/sbin/hw_crit_service_sys\
	$(LOCAL_PATH)/sbin/hw_ueventd:root/sbin/hw_ueventd\
	$(LOCAL_PATH)/sbin/kmsgcat:root/sbin/kmsgcat\
	$(LOCAL_PATH)/sbin/launch_daemonsu.sh:root/sbin/launch_daemonsu.sh\
